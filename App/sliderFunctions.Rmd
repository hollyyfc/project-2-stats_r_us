...
for (i in 0:4) {
x = i/4
p <- as.ggplot(expression(plot(boats, colorscale = protanopia, 
...
for (i in 0:4) {
x = i/4
p <- as.ggplot(expression(plot(boats, colorscale = deuteranopia, 
                               rescale = FALSE, axes = FALSE))) +
     coord_fixed()
print(p)
}
...
for (i in 0:4) {
x = i/4
p <- as.ggplot(expression(plot(boats, colorscale = tritanopia, 
                               rescale = FALSE, axes = FALSE))) +
     coord_fixed()
print(p)
}
...
for (i in 0:4) {
x = i/4
p <- as.ggplot(expression(plot(boats, colorscale = monochromatism, 
                               rescale = FALSE, axes = FALSE))) +
     coord_fixed()
print(p)
}
...
```{r fxn plz work}
#not sure what is best for website
```
